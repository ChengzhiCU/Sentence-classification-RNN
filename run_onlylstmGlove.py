...
from layers_1 import Relu, Softmax, Linear, Convolution,  ConvolutionSquare, Pooling, PoolingSquare, Batchnorm,Dropout,RNN4D,LSTM4D,ConvolutionSquareConst
...
model.add(LSTM4D('rnn1', batch_size,1, 32, 50 ,0.1))		#	HIDDEN_DIM, INPUT_DIM, 0.1


model.add(Linear('fc7',32*50 , 2048, 0.005))
...
solve_net(model, optim, train_data, train_label, test_data, test_label,
          batch_size=batch_size, max_epoch=100, disp_freq=250, test_freq=1000, half_step = 30, network_name = name)
#batch <30
