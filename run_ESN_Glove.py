...
from layers_1 import Relu, Softmax, Linear, Convolution,  ConvolutionSquare, Pooling, PoolingSquare, Batchnorm,Dropout,RNN4D,LSTM4D,ESN_4D
...
model.add(ESN_4D('rnn1', batch_size, 128, 100, 10 ,0.1))		#	HIDDEN_DIM, INPUT_DIM, 0.1
