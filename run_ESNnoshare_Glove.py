...
from layers_1 import Relu, Softmax, Linear, Convolution,  ConvolutionSquare, Pooling, PoolingSquare, Batchnorm,Dropout,RNN4D,LSTM4D,ESN_4D,ESN_4D_noshare
...
model.add(ESN_4D_noshare('rnn1', batch_size, 128, 100, 10 ,0.1))		#	HIDDEN_DIM, INPUT_DIM, 0.1


model.add(Linear('fc7',128*100*17 + 128*17*10 , 2048, 0.005))
...
solve_net(model, optim, train_data, train_label, test_data, test_label,
          batch_size=batch_size, max_epoch=150, disp_freq=250, test_freq=1000, half_step =10, network_name=name)
#batch <30
