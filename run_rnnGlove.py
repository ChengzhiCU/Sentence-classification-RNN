...
model.add(RNN4D('rnn1', batch_size, 128, 34, 10, 0.1))		#	HIDDEN_DIM, INPUT_DIM, 0.1
#model.add(LSTM4D('rnn1', batch_size, 128, 32, 10 ,0.1, True))

model.add(Linear('fc7',128*34*17 , 2048, 0.005))
...
optim = SGDOptimizerHalf(learning_rate=0.0001, weight_decay=0, momentum=0.9)
...
solve_net(model, optim, train_data, train_label, test_data, test_label,
          batch_size=batch_size, max_epoch=100, disp_freq=250, test_freq=250, half_step = 10, network_name = name)
#batch <30
