...
from layers_1 import Relu, Softmax, Linear, Convolution,  ConvolutionSquare, Pooling, PoolingSquare, Batchnorm,Dropout,RNN4D,RNN4D_noshare
...
model.add(RNN4D_noshare('rnn1', batch_size, 128, 16, 10, 0.1))		#	HIDDEN_DIM, INPUT_DIM, 0.1
#model.add(LSTM4D('rnn1', batch_size, 128, 32, 10 ,0.1, True))

model.add(Linear('fc7',128*16*17 , 2048, 0.005))
